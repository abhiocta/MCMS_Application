...
function Navbar() {
  ...
  const handleChatClick = () => {
    navigate('/hrchat'); // Navigate to the "/wechat" route
  };
    ...
    <AppBar position="static">
      <Container maxWidth="xl">
        <Toolbar disableGutters>
          ...
          <img src='happyservice.png' width='80px' height='70px' style={{paddingRight:'10px'}} onClick={handleNavigate}/>
